...
<html lang="utf-8">
		...
		<body>
			<header>Data Design Project</header>
			<main>
				<h1>Data Design Project</h1>

				<!-- Persona section -->
				<h2>Persona | Giles Sandoval | 30 years old</h2>
				<p>Profession: Youth minister. Leads a group of youths between the ages of 18-29 years old. Performs weekly messages to youth during weekdays. Does his bible study in the mornings and once in the evening. Requires a lexicon in the Greek and Hebrew definitions of the bible. Compared to the English language, A single word in the Greek or Hebrew could have multiple meanings in the English. He needs a lexicon to translate a word to word translation. He reads from the New King James Version of the bible, which is a literal (“word-to-word”) translation. And the he uses the Message version or the New Living Translation version as a “thought-to-thought” translation for the bible. He needs a Hebrew/Greek lexicon dictionary to help him dive deeper into the word.</p>
				...
				<!-- Use case section -->
				<h2>Use Case</h2>
				<p>His lead pastor gave him a task to speak on finances for the weekly message coming up. The lead pastor feels that it’s a subject that should be addressed to the youth ministry. He wants him to create a message tailored around the original Greek definitions of 2 specific verses. Over 50% of Jesus ministry were financial principles. The pastor gave him 2 verses to dive into and create a message surrounding those 2 verses. He’s welcome to refer to other verses with that SAME word used in the Greek, to help support the 2 main verses. He will use the dictionary to define specific words in the verse to paint a picture of that specific word used in that context, in that time, in that culture, and the meaning of what the word meant at the time it was written. I don’t want to have to sign in to look up a word.</p>
				...
				<h2>Interaction Flow</h2>
					<ul>
						...
						<li>“I want to hit a tab that brings me each word.”</li>
						<li>“I want to see the verse in English and in the original Greek right next to it.”</li>
						<li>“I want to click the link of the Greek word to lead me to the original Greek definition.”</li>
						...
						<li>“I would like a reference to what version of the bible I’m reading in English and what scroll was used to translate that version in the original scroll of Greek.”</li>
